...
# 3️⃣ Criar projeto Android mínimo
echo "Criando estrutura do projeto Android..."
rm -rf $BASE_DIR
mkdir -p $BASE_DIR
cd $BASE_DIR
...
# 4️⃣ Criar arquivos Gradle básicos
...
# 5️⃣ Gerar Gradle Wrapper completo
...
git init
git add .
git commit -m "Projeto Android VPN completo Termux + Gradle Wrapper + namespace + GitHub Actions"
